...
ALTER TABLE ONLY server.staff_hierarchy DROP CONSTRAINT staff_hierarchy_sub_staff_id_fkey;
ALTER TABLE ONLY server.staff_hierarchy DROP CONSTRAINT staff_hierarchy_chief_staff_id_fkey;
ALTER TABLE ONLY server.position_staff DROP CONSTRAINT position_staff_staff_id_fkey;
ALTER TABLE ONLY server.position_staff DROP CONSTRAINT position_staff_position_id_fkey;
ALTER TABLE ONLY server.office_staff DROP CONSTRAINT office_staff_staff_id_fkey;
ALTER TABLE ONLY server.office_staff DROP CONSTRAINT office_staff_office_id_fkey;
ALTER TABLE ONLY server.department_staff DROP CONSTRAINT department_staff_staff_id_fkey;
ALTER TABLE ONLY server.department_staff DROP CONSTRAINT department_staff_depart_id_fkey;
ALTER TABLE ONLY server.department_offices DROP CONSTRAINT department_offices_office_id_fkey;
ALTER TABLE ONLY server.department_offices DROP CONSTRAINT department_offices_depart_id_fkey;
ALTER TABLE ONLY server.deltas DROP CONSTRAINT deltas_delta_type_id_fkey;
CREATE OR REPLACE VIEW server.office_current_vacant_seats AS
SELECT
    NULL::integer AS id,
    NULL::numeric AS vacant_seats;
ALTER TABLE ONLY server.office_staff DROP CONSTRAINT unique_office_staff;
ALTER TABLE ONLY server.department_offices DROP CONSTRAINT unique_depart_office;
ALTER TABLE ONLY server.staff DROP CONSTRAINT staff_pkey;
ALTER TABLE ONLY server.staff_hierarchy DROP CONSTRAINT staff_hierarchy_chief_staff_id_sub_staff_id_key;
ALTER TABLE ONLY server.positions DROP CONSTRAINT positions_pkey;
ALTER TABLE ONLY server.position_staff DROP CONSTRAINT position_staff_position_id_staff_id_key;
ALTER TABLE ONLY server.offices DROP CONSTRAINT offices_pkey;
ALTER TABLE ONLY server.department_staff DROP CONSTRAINT department_staff_depart_id_staff_id_key;
ALTER TABLE ONLY server.department DROP CONSTRAINT department_pkey;
ALTER TABLE ONLY server.deltas_type DROP CONSTRAINT deltas_type_pkey;
ALTER TABLE ONLY server.deltas DROP CONSTRAINT deltas_pkey;
ALTER TABLE server.staff ALTER COLUMN id DROP DEFAULT;
ALTER TABLE server.positions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE server.offices ALTER COLUMN id DROP DEFAULT;
ALTER TABLE server.department ALTER COLUMN id DROP DEFAULT;
ALTER TABLE server.deltas_type ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE server.staff_id_seq;
DROP TABLE server.staff_hierarchy;
DROP SEQUENCE server.positions_id_seq;
DROP SEQUENCE server.offices_id_seq;
DROP TABLE server.office_staff;
DROP VIEW server.find_namesakes_all;
DROP VIEW server.departments_wealthiest_staff;
DROP TABLE server.staff;
DROP TABLE server.positions;
DROP TABLE server.position_staff;
DROP TABLE server.department_staff;
DROP TABLE server.department_offices;
DROP SEQUENCE server.department_id_seq;
DROP TABLE server.department;
DROP SEQUENCE server.deltas_type_id_seq;
DROP TABLE server.deltas_type;
DROP TABLE server.deltas;
DROP VIEW server.current_office_occupancy;
DROP TABLE server.offices;
DROP SEQUENCE server.offices_seq;
DROP VIEW server.office_current_vacant_seats;
DROP FUNCTION server.link_staff_w_office(stff_id integer, office_id integer);
DROP FUNCTION server.find_namesakes(staff_id integer, OUT outp server.find_namesakes_out);
DROP FUNCTION server.current_office_occupancy_func(is_desc boolean);
DROP TYPE server.find_namesakes_out;
